...
class QuizControllerTest {
    ...
    @DisplayName("quiz(): GET /quiz?code=1 이면 응답 코드는 201, QuizControllerTest.java 응답 본문은 Created!를 리턴한다.")
    @Test
    ...
    @DisplayName("quiz(): POST /quiz?code=1 이면 응답 코드는 403, QuizControllerTest.java 응답 본문은 Forbidden!를 리턴한다.")
